...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'reduce.wast';
  var wasmBinaryFile = 'reduce.wasm';
  var asmjsCodeFile = 'reduce.temp.asm.js';
...
Module['wasmTableSize'] = 7233;

Module['wasmMaxTableSize'] = 7233;
...
var real__reduce = asm["_reduce"]; asm["_reduce"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__reduce.apply(null, arguments);
};
...
var _reduce = Module["_reduce"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_reduce"].apply(null, arguments) };
