...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'map.wast';
  var wasmBinaryFile = 'map.wasm';
  var asmjsCodeFile = 'map.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_map_cpp() } });
...
var real__map = asm["_map"]; asm["_map"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__map.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_map_cpp = Module["__GLOBAL__sub_I_map_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_map_cpp"].apply(null, arguments) };
...
var _map = Module["_map"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_map"].apply(null, arguments) };
